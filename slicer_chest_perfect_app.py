...
img = image.load_img("D:/radiopaedia_org_covid-19-pneumonia-7_85703_0-dcm.nii")
mat = img.affine
img = img.get_fdata()
                        ...
                        dbc.Row(
                            [
                                dbc.Col(
                                    html.A(
                                        html.Img(
                                            src=app.get_asset_url("dash-logo-newt.png"),
                                            height="30px",
                                        ),
...
def update_segmentation_slices(selected, annotations):
    ...
    if (
        ...
        mask = np.zeros_like(med_img, dtype=np.uint8)
